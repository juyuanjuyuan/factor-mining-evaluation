#!/usr/bin/env python3
"""Validate all 52 executable Alpha101 expressions on synthetic wide data."""
...
def main() -> None:
    ...
    factors = select_registered_factors("all", implementation_set="exact")
    assert len(factors) == 52
    ...
    try:
        select_registered_factors("5", implementation_set="exact")
    except ValueError:
        pass
    else:
        raise AssertionError("alpha005 should require unavailable VWAP")

    print("52 executable Alpha101 expressions passed")
