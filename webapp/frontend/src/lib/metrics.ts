...
export const METRIC_SPECS: Record<string, MetricSpec> = {
  ...
  tradability_masked_delisting_obs: spec('退市整理期剔除', '数据质量', 'int'),
  tradability_masked_signal_st_obs: spec('信号日 ST 剔除', '数据质量', 'int'),
  tradability_masked_entry_st_obs: spec('买入日 ST 剔除', '数据质量', 'int'),
  tradability_masked_signal_delisting_obs: spec('信号日退市整理期剔除', '数据质量', 'int'),
  tradability_masked_entry_delisting_obs: spec('买入日退市整理期剔除', '数据质量', 'int'),
  tradability_masked_entry_no_trade_obs: spec('买入日无成交剔除', '数据质量', 'int'),
